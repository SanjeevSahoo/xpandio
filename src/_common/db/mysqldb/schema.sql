...
insert into t_exp_menus (menu_icon, status,name, mas_id, sr_no, menu_type, menu_url, project_id, module_id, crt_date) values ('dashboard','Active', 'Dashboard', null, 1, 'Relative', '/dashboard', 0, null, NOW());
