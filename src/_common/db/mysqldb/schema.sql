...
insert into t_exp_projects (name, status, short_desc, stage, hosting_status, disp_name, logo_url, project_lead_id, creation_type, client_dept, client_spoc_id, team_id, crt_date, upd_date, base_url) values ('Questin and Answer App', 'Active', 'A Question and Anwer module for general discussion on various categories', 'Development', 'In App', 'QnA App', 'qna_logo.png', 1, 'App', 'Internal', 1, 1, NOW(), NOW(),'/qna');
